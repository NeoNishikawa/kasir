    ...
    <div class="container">
        ...
        <div class="mx-auto rounded p-5" style="width: 500px; background-color: white;">
            ...
            <form id="form" action="login.php" method="POST">
                ...
                <input class="form-control mx-auto d-block" type="text" name="username" placeholder="Username" required><br>

                <input class="form-control mx-auto d-block" type="password" name="password" placeholder="Password" required><br>
